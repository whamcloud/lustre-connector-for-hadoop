...
/**
 * Throw a native IO exception corresponding to an error
 * that occurred during a native operation.
 *
 * @param env           The JNI environment
 * @param errnum		The system call error
 */
void throw_nioe(JNIEnv *env, int errnum);

/**
 * Create a new Native IOException.
 *
 *
 * @param env           The JNI environment
 * @param errnum		The system call error
 *
 * @return              The Native IOException
 */
